...
for ind, eachact in actcount.items():
    ...
    df_transdata.index = pd.DatetimeIndex(df_transdata.index).to_period('M')    # [1]
...
"""  
# Hyperparameter tuning is not possible for CNN as it is throwing error [2]
