...
# WITHDRAWAL_AMT and DEPOSIT_AMT attributes, will be filled with 0 in the step 3.4
...
# Calling PlotPiechartPerAccount to plot pie chart for each account to show the TRANSACTION_DETAILS
# against WITHDRAWAL_AMT and DEPOSIT_AMT
PlotPiechartPerAccount(dfbankdataset, 'WITHDRAWAL_AMT')
PlotPiechartPerAccount(dfbankdataset, 'DEPOSIT_AMT')
# Referemce: https://www.delftstack.com/howto/python-pandas/python-to-plot-pie-chart-and-table-of-pandas-dataframe/    
...
# To visualize the data, heat map is demonstrated below [7]
...
#outliers_wa, dfbankdataset["WITHDRAWAL_AMT"] = FindOutliers_IQR(dfbankdataset["WITHDRAWAL_AMT"])
#outliers_da, dfbankdataset["DEPOSIT_AMT"] = FindOutliers_IQR(dfbankdataset["DEPOSIT_AMT"])
#outliers_ta, dfbankdataset["TRANSACTION_AMOUNT"] = FindOutliers_IQR(dfbankdataset["TRANSACTION_AMOUNT"])
...
# https://github.com/krishnaik06/Live-Time-Series/blob/main/Time%20Series%20EDA.ipynb
