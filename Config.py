...
#categorylist = ['Indiaforensic', 'fdrl', 'npci', 'dsb', 'sbi', 'oxygen', 'hdfc', 'neft', 'imps', 'NoTransDetail', 'aeps']
...
"""
categorylist = ['2DFINE', 'AAB ENTERPRISES', 'ACCOUNT', 'ACQ', 'ADJ', 'AEPS', 'AIRPAY', 'AIRTEL', 'ALT DIGITAL', 
                'APPNIT', 'ATLAS', 'ATM', 'AVENUES INDIA PRIVATE LIM', 'AWARDS', 'AXEL',
                'BAJAJ ALLIANZ', 'Bank Guar', 'BASIST', 'BBPS', 'BEAT CSH', 'BEST', 'BHAGALPUR ELECTRICITY DIS', 
                'BIDDERBOY CORPORATION', 'BIGTREE ENTERTAINMENT PRI', 'BILLPAY', 'BIRLA', 'BLUE DART', 'BONUSHUB', 
                'BOOK', 'BOWMAN', 'BSES RAJDHANI POWER LIMIT', 'BSES YAMUNA POWER LIMITED', 
                'CALLHEALTH ONLINE SERVICE', 'CASH', 'CATENA TECHNOLOGIES PRIVA', 'CB', 'CDUTWL', 'CESS', 
                'Charges', 'CHQ', 'CLEARCAR RENTAL PRIVATE L', 'Closure', 'COMMDEL CONSUTING SERVICE', 
                'CONFEDERATION OF INDIAN I', 'CREDIT', 'CRY', 'CULLIGENCE SOFTWARE', 'DD', 'DEFERRED', 
                'DEN NETWORKS LIMITED', 'DHL', 'DIGITAL', 'DISH INFRA SERVICES PRIVA', 'Dr.', 'Draw Down', 'dsb',
                'E SUVIDHA', 'E-BILLING SOLUTIONS PRIVA', 'EIH', 'ELEGANCE FASHION AND YOU', 'EMBEE SOFTWARE PVT LTD',
                'ETRAVELVALUE', 'FACEBOOK', 'FAKE', 'FD', 'fdrl', 'FEDEX', 'FEE', 'FERNS', 'FINSPIRE SOLUTIONS PRIVAT',
                'FIXED MOBILE', 'FROM RBL BANK LTD', 'FT ZL', 'FTR', 'FUJIAN', 'FUTURE RETAIL LIMITED', 
                'FX CONV CHGS', 'GOLD', 'GOLF', 'GST', 'HAPPYDEAL18', 'hdfc', 'HINDUSTAN SERVICE STATION', 'HOSPITAL', 
                'HUDA', 'IFSC', 'IMAR', 'imps', 'Indfor', 'Indiaforensic', 'INDIAIDEAS', 'INDIAN OIL', 'INDO', 
                'INFOEDGE INDIA LTD', 'INT', 'INWARD', 'IO', 'IRCTC', 'IRTT', 'IW CLG', 'IWSTHCTS1', 'JANA', 
                'JUST DIAL LIMITED','KAYGEES', 'KRYPTOS MOBILE PRIVATE LI', 'LINKEDIN SINGAPORE PTE LT', 
                'LOCALCUBE COMMERCE PRIVAT', 'MAD', 'MAESTRO', 'MARGIN', 'MARKING', 'MASTER', 'MAW', 'MDR', 
                'MEHAR ENTERTAINMENT PRIVA', 'MEHER ENTERTAINMENT PRIVA', 'MERU CAB COMPANY PRIVATE', 
                'METRO INFRASYS PRIVATE LI', 'MICRO', 'MS EMBEE SOFTWARE', 'MTNL', 'MUZAFFARPUR VIDYUT VITARA', 
                'NATIONAL', 'neft', 'NETHOPE', 'NFS', 'NOMISMA MOBILE SOLUTIONS', 'NORTH DELHI POWER LTD', 
                'NoTransDetail', 'npc', 'OBEROI', 'OFT', 'OM GANESH', 'OMNICOM MEDIA GROUP INDIA', 'ONLINE', 
                'ORAVEL STAYS PRIVATE LIMI', 'ORTT', 'OUTWARD', 'OW RET', 'oxygen', 'PASFAR TECHNOLOGIES PRIVA', 
                'PAYGATE INDIA PRIVATE LIM', 'Payments', 'Payoff', 'PENALITY', 'PENALTY', 'PENDING', 'PENLTY', 
                'PVR LIMITED', 'QUINSEL SERVICES PRIVATE', 'QWIKCILVER SOLUTIONS', 'RAI', 'RAJMATAJI', 'RECOVERY', 
                'REJ', 'REP', 'Repayment', 'REV', 'REVERSE LOGISTICS COMPANY', 'RF', 'RMCPL', 'ROYAL INFOSYS', 'RPT', 
                'RTGS', 'RUPAY', 'sbi', 'SEND MONEY', 'SERVICE TX', 'SHENZHEN JUSTTIDE TECH CO', 
                'SHREEJEE PRIME INFOTECH P', 'SKORYDOV', 'SMARTSERV INFOSERVICES PR', 'SND LIMITED', 
                'SONATA FINANCE PRIVATE LI', 'SPORTS', 'SRS LIMITED', 'SRVC TX', 'STAMP', 'SWACHH', 
                'SYNERGISTIC FINANCIAL NET', 'TAKEOVER', 'TATA', 'TAX', 'TDS', 'TELECOM', 'TELEPOWER', 'TELPOWER', 
                'THE UNIWORLD CITY', 'TITAN', 'TNT', 'TO For', 'TPF', 'TRANGLO', 'TransNum', 'TRAVEL', 'TRF', 
                'UPI', 'USD', 'VAISHANVI', 'VENDOR', 'VINILOK SOLUTIONS', 'VISA', 'VODAFONE', 'VOUCHER', 
                'VOYLLA FASHIONS PRIVATE L', 'WAIVE', 'WORLD WIDE FUND', 'ZAAK EPAYMENT SERVICES PR', 'ZEN', 'RefNum']
